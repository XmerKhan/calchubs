        ...
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none space-y-8 text-muted-foreground">
            ...
            <section>
              ...
              <p>CalcHub uses cookies for the following purposes:</p>
            ...
            <section>
              ...
              <p className="mt-4">
                These third parties have their own privacy and cookie policies which govern how they use the data they collect.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                If you have questions about our use of cookies, please contact us at privacy@calchub.com.
              </p>
            </section>
          </div>
        </div>
