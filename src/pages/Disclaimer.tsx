        ...
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none space-y-8 text-muted-foreground">
            ...
            <section>
              ...
              <p>
                The content on CalcHub does not constitute professional advice. Specifically:
              </p>
            ...
            <section>
              ...
              <p>
                We make every effort to ensure our calculators use accurate formulas and produce correct results. However:
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-4">
            ...
            <section>
              ...
              <p>
                In no event will CalcHub be liable for any loss or damage including without limitation, indirect or consequential loss or damage, or any loss or damage whatsoever arising from loss of data or profits arising out of, or in connection with, the use of this website.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Through this website, you may link to other websites which are not under the control of CalcHub. We have no control over the nature, content, and availability of those sites. The inclusion of any links does not necessarily imply a recommendation or endorse the views expressed within them.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                You acknowledge that you use CalcHub's calculators at your own risk. You are responsible for:
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-4">
            ...
            <section>
              ...
              <p>
                If you have questions about this disclaimer, please contact us at legal@calchub.com.
              </p>
            </section>
          </div>
        </div>
